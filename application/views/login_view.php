...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="index.php" style="color: White;"><b>SISTEM INFORMASI<br/><b>PERPUSTAKAAN KOTA </b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: White;"> Copyright &copy; Sistem Informasi Perpustakaan Kota <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
